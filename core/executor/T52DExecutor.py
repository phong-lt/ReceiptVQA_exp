...
from core.model import T52D
from core.data import Text2DVQADataset, textlayout_ocr_adapt
...
class T52DExecutor():
    ...
    def _create_data_utils(self):
        ...
        self.train_data = Text2DVQADataset(
                                        qa_df = train_qa_df,
                                        ocr_df = ocr_df,
        ...
        self.val_data = Text2DVQADataset(
                                        qa_df = val_qa_df,
                                        ocr_df = ocr_df,
                                        tokenizer = self.tokenizer,
                                        max_input_length = self.config.max_input_length,
    ...
    def _init_eval_predict_mode(self):
        ...
        if self.mode == "eval":
            ...
            self.predict_data = Text2DVQADataset(
                                                qa_df = predict_qa_df,
                                                ocr_df = ocr_df,
                                                tokenizer = self.tokenizer,
                                                max_input_length = self.config.max_input_length,
